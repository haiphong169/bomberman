...
public class Minvo extends Enemy{
    ...
    public Minvo(double x, double y, double width, double height, Image image, double velocity) {
        ...
        if (!isDying) {
            ...
            switch (direction) {
                case LEFT:
                    ...
                    switch (step % 15) {
                        case 0:
                            setImage("minvo_left1.png");
                            break;
                        case 5:
                            setImage("minvo_left2.png");
                            break;
                        case 10:
                            setImage("minvo_left3.png");
                            break;
                    }
                    break;
                case RIGHT:
                    ...
                    switch (step % 15) {
                        case 0:
                            setImage("minvo_right1.png");
                            break;
                        case 5:
                            setImage("minvo_right2.png");
                            break;
                        case 10:
                            setImage("minvo_right3.png");
                            break;
                    }
                    break;
                case UP:
