...
public class Doll extends Enemy{
    ...
    public Doll(double x, double y, double width, double height, Image image, double velocity) {
        ...
        if (!isDying) {
            ...
            switch (direction) {
                case LEFT:
                    ...
                    switch (step % 15) {
                        case 0:
                            setImage("doll_left1.png");
                            break;
                        case 5:
                            setImage("doll_left2.png");
                            break;
                        case 10:
                            setImage("doll_left3.png");
                            break;
                    }
                    break;
                case RIGHT:
                    ...
                    switch (step % 15) {
                        case 0:
                            setImage("doll_right1.png");
                            break;
                        case 5:
                            setImage("doll_right2.png");
                            break;
                        case 10:
                            setImage("doll_right3.png");
                            break;
                    }
                    break;
                case UP:
